...
const routes = [
  { path: '/', name: 'Home', component: () => import('../views/Home.vue'), meta: { title: '十年之约 · 我和D5的未来对话' } },
  { path: '/login', name: 'Login', component: () => import('../views/Login.vue'), meta: { title: '登录' } },
  { path: '/upload', name: 'Upload', component: () => import('../views/Upload.vue'), meta: { title: '上传作品', auth: true } },
  { path: '/vote-result', name: 'VoteResult', component: () => import('../views/VoteResult.vue'), meta: { title: '投票结果', admin: true } },
  { path: '/main-awards', name: 'MainAwards', component: () => import('../views/MainAwards.vue'), meta: { title: '主奖项', admin: true } },
...
router.beforeEach((to, from, next) => {
  document.title = to.meta.title ? `${to.meta.title}` : '十年之约 · 我和D5的未来对话';
