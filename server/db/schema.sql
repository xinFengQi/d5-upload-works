...
INSERT OR IGNORE INTO screen_config (id, grid_layout, theme_json, updated_at)
VALUES (1, '2x2', '{"primaryColor":"#2563eb","primaryDark":"#1e40af","primaryLight":"#3b82f6","secondaryColor":"#64748b"}', strftime('%s','now')*1000);
